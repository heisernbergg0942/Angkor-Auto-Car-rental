...
import { Mail, Lock, ArrowRight, ShieldCheck, AlertCircle, Loader2, Eye, EyeOff } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleEmailChange = (e) => {
    ...
    setEmail(nextEmail);
    localStorage.setItem('login_email', nextEmail);
  };
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-11 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D6A4F]/20 focus:border-[#2D6A4F] transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
